...
echo -n -e "CHROM\tPOS\tEND\tID\tSVTYPE\tPLATFORM\tSVLEN\tSRC\tGENCODE\tdenovo_LR\tdenovo_LR_LC\tMAT_INH_LR\tMAT_INH_LR_LC\tPAT_INH_LR\tPAT_INH_LR_LC\tdenovo_IL\tdenovo_IL_LC\tMAT_INH_IL\tPAT_INH_IL\tAC\tPASS_STRICT\tTR50\tSD50\tHWP\tSQ5_SAMPLES\tSQ10_SAMPLES\tSQ20_SAMPLES\tSQ30_SAMPLES\tSQ40_SAMPLES\tAD2_SAMPLES\tAD3_SAMPLES\tAD4_SAMPLES\tAD5_SAMPLES\tAD1_P_ALT_SAMPLES\tAD1_P_REF_SAMPLES\tAD1_M_ALT_SAMPLES\tAD1_M_REF_SAMPLES\tAD1_N_ALT_SAMPLES\tAD1_N_REF_SAMPLES\tHET_SAMPLES\tHOMALT_SAMPLES\tZERO_COV_SAMPLES\tgnomadV4_AF\tgnomadV4_PC\tgnomadV4_POPMAX_AF\tgnomadV4_name\tGNOCCHI\tFB_PR_ENH_M\tFB_PR_ENH_F\tFANTOM_ENH\tConsequence\tIMPACT\tSYMBOL\tGENE\tBIOTYPE\tDISTANCE\tTSSDistance\tAF_FOUNDER_LR\tAF_OFFSPRING_LR\tAF_FOUNDER_IL\tAF_OFFSPRING_IL\n" > $VEP_OUT
bcftools +split-vep -X -c Gene,BIOTYPE,SYMBOL,IMPACT,EXON,INTRON,Consequence,DISTANCE,STRAND,OverlapBP,OverlapPC,gnomadV4_AF,gnomadV4_PC,gnomadV4_POPMAX_AF,gnomadV4_name,TSSDistance,GENCODE,GNOCCHI,FB_PR_ENH_M,FB_PR_ENH_F,FANTOM_ENH \
 -i '(SVLEN<2e6 && SVLEN>-2e6) || SVTYPE=="BND"' \
